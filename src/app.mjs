...
function activityTab(){
 ...
 const netoDim=nv?panel('Margen NETO por cliente y por zona',
   ...
   '<div class="info">Coeficientes del reparto: <b>'+eur(nv.coef.lit)+' / litro</b> · <b>'+eur(nv.coef.dur*60)+' / hora</b> · <b>'+eur(nv.coef.km)+' / km</b>. Es una atribución con método, no una factura por cliente; los directos (áridos/subcontratación) se afinarán a su cliente real.</div>'
