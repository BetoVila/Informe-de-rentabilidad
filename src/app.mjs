...
function viajesTab(){
 ...
 const triHtml=tri?`<div class="info"><b>Triangulación v${tri.version||2}</b> (${esc(tri.generado||'')}): <b>${nf(tri.medido||0)}</b> de ${nf(tri.viajes||0)} viajes de áridos/nacional con <b>hora real de inicio y fin</b> (${tri.pct||0} %; áridos ${tri.aridos_pct||0} %) · confianza alta ${nf(tri.alta||0)} / media ${nf(tri.media||0)} · minutos del <b>tacógrafo</b> en ${nf(tri.taco||0)} viajes · el chofer del tacógrafo coincide con GesRuta en ${nf(tri.chofer_ok||0)} de ${nf((tri.chofer_ok||0)+(tri.chofer_no||0))} · jornadas nocturnas ${nf(tri.nocturnas||0)} · albaranes sin ciclo en la traza ${nf(tri.sin_ciclo||0)} (<b>sin dato, no cero</b>) · sin traza ${nf(tri.sin_traza||0)} · nº de cantera repetido (error de grabación) ${nf(tri.repetidas||0)} · largas distancias pendientes de la pasada de nacional ${nf(tri.largas||0)}. <b>Inicio/Fin</b> en hora de Madrid («+1» = acaba al día siguiente: viaje nocturno).</div>`:'';
