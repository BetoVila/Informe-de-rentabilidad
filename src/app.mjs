...
function activityTab(){
 ...
 const rutas=panel('Rutas principales (origen → destino)','Primeras 20 combinaciones de provincia de origen y destino por número de viajes.',simpleTable([{label:'Ruta',key:'key'},numberCol('Viajes','viajes'),numberCol('m³','m3',1),numberCol('Toneladas','t',2),numberCol('Km','km'),moneyCol('Importe','imp')],v.rutas.slice(0,20)));
...
function viajesTab(){
 ...
 const cols=[{label:'Día',key:'dia',center:true},{label:'Cliente',key:'cliente'},{label:'Lugar de carga',key:'carga'},{label:'Lugar de descarga',key:'descarga'},{label:'Provincias',key:'ruta'},{label:'Matrícula',key:'mat',center:true}]
  ...
  .concat([numberCol('m³','m3',1),numberCol('Toneladas','t',2),numberCol('Km','km')])
