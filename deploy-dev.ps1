...
Copy-Item -LiteralPath (Join-Path $r 'Actualizar.ps1'),(Join-Path $r 'Poner-clave-personal.ps1'),(Join-Path $r 'Poner-sal-conductores.ps1'),(Join-Path $r 'LEEME.txt') -Destination $pp -Force
