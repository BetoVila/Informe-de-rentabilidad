...
8. **Resultado según combustible y personal**: en Resumen, panel sobre la contabilidad real. Combustible (cuenta 628) y personal (640-649) son los dos costes que más mueven el resultado; se enseña su peso **sobre el total y sobre los viajes propios**, y qué pasaría con el resultado si suben (frases claras «Si el gasoil sube un 5 %, el resultado quedaría en X (cambio −Y)», por separado y juntos; se descartó la matriz combustible×personal por ilegible para un lector no técnico). Respeta periodo, sociedad y el selector Suma/Consolidada.
9. **Viajes propios vs subcontratados**: combustible y personal son costes de NUESTRA flota, así que su peso real es sobre la facturación de los viajes que hacen nuestros camiones, no sobre el total. `model.ownFleet(f)` separa la facturación de GesRuta según la **matrícula sea de la sociedad** (matrícula→sociedad por sus partes de Access), con el ámbito de la empresa elegida: para Agetrans sola, un viaje con camión de Razo es subcontratado; a nivel grupo, es propio. Validado contra la cuenta 607 (Agetrans subcontrata el ~72 %; Razo ~9 %). Ejemplo: el gasoil de Agetrans es 9,9 % del total pero 34,8 % de sus viajes propios.
10. **Sensor de consumo: no lo llevan todos los camiones**. El consumo (litros) solo lo miden los vehículos CON MOTOR (tractora, rígido) que llevan el sensor; un remolque no gasta gasoil. El tipo sale del ERP (`fleet_vehicle.razo_clase`, traído por el extractor de Movertis), no de la matrícula. El consumo del informe se calcula solo con los camiones con sensor; el detalle (qué camión lo tiene, con Sí/No por matrícula) está en Conciliación y el recuento en «Medido por el camión».
11. **Access es un documento vivo**: los dos lectores de Access (partes y personal) **copian el fichero y leen la copia** (foto estable), así una lectura no falla ni lee a medias aunque lo estén usando. Nunca se abre ni se modifica el Access de la gente.
